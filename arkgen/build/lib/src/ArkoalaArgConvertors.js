...
exports.ArkoalaMaterializedClassConvertor = exports.ArkoalaImportTypeConvertor = exports.ArkoalaInterfaceConvertor = void 0;
const idl = require("@idlizer/core/idl");
const core_1 = require("@idlizer/core");
class ArkoalaInterfaceConvertor extends core_1.InterfaceConvertor {
    unionDiscriminator(value, index, writer, duplicates) {
        if (writer.language === core_1.Language.ARKTS)
...
exports.ArkoalaInterfaceConvertor = ArkoalaInterfaceConvertor;
class ArkoalaImportTypeConvertor extends core_1.ImportTypeConvertor {
...
exports.ArkoalaImportTypeConvertor = ArkoalaImportTypeConvertor;
ArkoalaImportTypeConvertor.knownTypes = new Map([
...
class ArkoalaMaterializedClassConvertor extends core_1.MaterializedClassConvertor {
    unionDiscriminator(value, index, writer, duplicates) {
        if (writer.language === core_1.Language.ARKTS)
            return writer.instanceOf(value, this.idlType);
...
exports.ArkoalaMaterializedClassConvertor = ArkoalaMaterializedClassConvertor;
//# sourceMappingURL=ArkoalaArgConvertors.js.map