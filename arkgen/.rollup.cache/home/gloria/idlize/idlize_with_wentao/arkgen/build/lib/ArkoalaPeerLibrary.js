...
import { CustomTypeConvertor, isMaterialized, isImportAttr, Language, PeerLibrary, IndentedPrinter, TSLanguageWriter, CppConvertor, CppLanguageWriter, JavaLanguageWriter, ETSLanguageWriter, CJLanguageWriter, CJIDLTypeToForeignStringConvertor, isBuilderClass, TSTypeNameConvertor, ETSTypeNameConvertor } from "@idlizer/core";
...
export class ArkoalaPeerLibrary extends PeerLibrary {
    createLanguageWriter(language) {
        ...
        switch (language) {
            case Language.TS: return new TSLanguageWriter(printer, this, new TSTypeNameConvertor(this));
            case Language.ARKTS: return new ETSLanguageWriter(printer, this, new ETSTypeNameConvertor(this), new CppConvertor(this));
            case Language.JAVA: return new JavaLanguageWriter(printer, this, new ArkoalaJavaTypeNameConvertor(this));
            case Language.CPP: return new CppLanguageWriter(printer, this, new CppConvertor(this), ArkPrimitiveTypesInstance);
            case Language.CJ: return new CJLanguageWriter(printer, this, new ArkoalaCJTypeNameConvertor(this), new CJIDLTypeToForeignStringConvertor(this));
