 ...
 */
export function mapNumberType(context) {
 ...
 * @returns 合适的单位字符串
 */
export function selectLengthUnit(propertyName) {
 ...
 * @returns 格式化的默认值
 */
export function generateLengthDefault(propertyName, unit) {
    const name = propertyName || '';
    // 根据属性类型选择合适的默认值
 ...
 */
export function convertNumberProperty(input) {
    var _a;
